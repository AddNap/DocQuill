...
from docquill.document_api import Document as DocumentAPI
...
class TestDocumentAPI:
    ...
    def test_open_document_with_mock(self):
        ...
        with patch('docquill.parser.package_reader.PackageReader', return_value=mock_reader), \
             patch('docquill.parser.xml_parser.XMLParser', return_value=mock_parser):

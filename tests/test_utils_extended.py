...
from docx_interpreter.utils.color_utils import ColorUtils
from docx_interpreter.utils.id_manager import IDManager
from docx_interpreter.utils.validators import DocumentValidators
from docx_interpreter.utils.cache import Cache
...
class TestDocumentValidators:
    ...
    def test_validate_document_structure_valid(self):
        ...
        from docx_interpreter.models.base import Models

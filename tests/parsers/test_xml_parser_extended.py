...
class TestXMLParserExtended:
    ...
    def xml_parser(self, mock_package_reader):
        ...
        with patch('docx_interpreter.parser.numbering_parser.NumberingParser') as mock_np_class:
            with patch('docx_interpreter.styles.style_manager.StyleManager') as mock_sm_class:

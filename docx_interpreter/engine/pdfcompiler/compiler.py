...
from docx_interpreter.engine.unified_layout import LayoutBlock, LayoutPage
from docx_interpreter.engine.geometry import Size, twips_to_points
                    ...
                    if entry_runs:
                        ...
                        for run in entry_runs:
                            ...
                            if run_image:
                                ...
                                from docx_interpreter.engine.base_engine import LayoutBlock
                ...
                if not isinstance(para, dict) and hasattr(para, "runs"):
                    ...
                    for run in para_runs:
                        ...
                        if hasattr(run, "image") and run.image:
                            ...
                            from docx_interpreter.engine.geometry import emu_to_points
